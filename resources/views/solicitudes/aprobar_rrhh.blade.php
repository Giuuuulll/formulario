...
<h2 class="mb-4">Revisión de RRHH</h2>
...
================================ -->
<form id="formAprobacion" method="POST" action="{{ route('solicitudes.aprobarRRHH', $solicitud->id) }}">
    @csrf

    <!-- Campo oculto donde JS pondrá el comentario -->
